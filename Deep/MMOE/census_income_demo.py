...
from Deep.MMOE.mmoe import MMoE
...
def data_preparation():
    ...
    train_df = pd.read_csv('../../Data/census-income/census-income.data',sep=',',names=column_names)
    test_df = pd.read_csv('../../Data/census-income/census-income.test',sep=',',names=column_names)
...
def main():
    ...
    for index, task_layer in enumerate(mmoe_layers):
        ...
        output_layer = layers.Dense(units=output_info[index][0], name=output_info[index][1], activation='softmax',kernel_initializer=VarianceScaling())(tower_layer)
